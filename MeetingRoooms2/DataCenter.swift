...
class DataCenter {
    ...
    var filePath:String {
        get {
            let documentDirectory = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first // first of Array
    ...
    func defaultData() -> Array<Branch> {
        ...
        let riverRoom = MeetingRoom(name: "River", capacity: 8)
