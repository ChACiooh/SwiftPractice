...
class EquipmentsListViewController: UITableViewController {
    ...
    var equipments:Array<Any> = [] // Cocoa의 NSDictionary를 쓰므로 바로 Dictionary 타입으로 지정 불가.
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EquipmentsCell", for: indexPath)

        // Configure the cell...
        
        guard let equipment = equipments[indexPath.row] as? [String:Any] else {
            return cell
        }
