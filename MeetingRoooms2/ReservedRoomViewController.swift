//
//  ReservedRoomViewController.swift
//  MeetingRoooms2
//
...
class ReservedRoomViewController: UITableViewController {

    @IBOutlet weak var hostNameField: UITextField!
    
    
    @IBOutlet weak var datePickker: UIDatePicker!
    
    
    @IBOutlet weak var attendeesField: UITextField!
    
    
    @IBOutlet weak var equiptmentField: UITextField!
    ...
    func newReservation() -> Reservation? {
        ...
        reservation.date = datePickker.date as NSDate
        
        if let equiptmentArray = equiptmentField.text?.characters.split(separator: ",").map(String.init) {
            reservation.equipments = equiptmentArray
        }
